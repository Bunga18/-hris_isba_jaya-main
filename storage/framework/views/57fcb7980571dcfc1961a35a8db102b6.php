    ...
    <div class="flex items-center gap-2 flex-wrap">
      ...
      <div class="relative" x-data="{ open: false }">
        ...
        <div x-show="open" @click.away="open = false"
          ...
          <a href="<?php echo e(route('admin.members.export.excel')); ?>"
          ...
          <a href="<?php echo e(route('admin.members.export.pdf')); ?>"
            class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
    ...
    <form method="GET" action="<?php echo e(route('admin.members.index')); ?>"
      ...
      <div class="w-full sm:w-40">
        ...
        <select name="status" class="form-select">
          ...
          <?php $__currentLoopData = ['Aktif','Tidak Aktif','Alumni','Pending']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="card">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-gray-400 text-center">
              <?php echo e(($members->currentPage() - 1) * $members->perPage() + $loop->iteration); ?>
            ...
            <td class="font-mono text-gray-500 text-xs"><?php echo e($member->nim); ?></td>

            
            <td><?php echo e($member->department->name ?? '-'); ?></td>

            
            <td class="text-gray-600"><?php echo e($member->position->name ?? '-'); ?></td>
            ...
            <td>
              <div class="flex items-center justify-center gap-1">
                ...
                <button onclick="confirmDelete('<?php echo e($member->id); ?>', '<?php echo e($member->full_name); ?>')"
                ...
                <form id="delete-form-<?php echo e($member->id); ?>"
                  action="<?php echo e(route('admin.members.destroy', $member)); ?>"
    ...
    <div class="px-5 py-4 border-t border-gray-100 flex items-center justify-between">
      <p class="text-sm text-gray-500">
        Menampilkan <?php echo e($members->firstItem()); ?>–<?php echo e($members->lastItem()); ?>

        dari <span class="font-semibold text-navy"><?php echo e($members->total()); ?></span> anggota
      </p>
      <div class="flex items-center gap-1">
        ...
        <?php else: ?>
        <a href="<?php echo e($members->previousPageUrl()); ?>"
          class="px-2.5 py-1.5 text-gray-600 border border-gray-200 rounded-lg text-sm hover:bg-gray-50">←</a>
        <?php endif; ?>

        
        <?php $__currentLoopData = $members->getUrlRange(1, $members->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e($url); ?>"
          class="px-3 py-1.5 rounded-lg text-sm font-medium
          <?php echo e($page == $members->currentPage()
        ...
        <a href="<?php echo e($members->nextPageUrl()); ?>"
          class="px-2.5 py-1.5 text-gray-600 border border-gray-200 rounded-lg text-sm hover:bg-gray-50">→</a>
        <?php else: ?>
        <span class="px-2.5 py-1.5 text-gray-300 border border-gray-200 rounded-lg text-sm cursor-not-allowed">→</span>
        <?php endif; ?>
...
<div id="modal-import" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md">
    ...
    <form action="<?php echo e(route('admin.members.import')); ?>" method="POST" enctype="multipart/form-data">
      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\hris_isba_jaya-main\resources\views/admin/members/index.blade.php ENDPATH**/ ?>